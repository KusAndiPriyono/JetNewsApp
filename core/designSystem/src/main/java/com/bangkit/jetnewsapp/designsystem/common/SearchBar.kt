...
fun SearchBar(
    ...
    val interactionSearch = remember {
        MutableInteractionSource()
    }
    val isClicked = interactionSearch.collectIsFocusedAsState().value
    ...
    Box(modifier = modifier) {
        TextField(
            ...
            leadingIcon = {
                Icon(
                    painter = painterResource(id = com.bangkit.jetnewsapp.designsystem.R.drawable.ic_search),
            ...
            interactionSource = interactionSearch
        )
    }
